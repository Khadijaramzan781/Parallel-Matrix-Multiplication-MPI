...
2. Amdahl’s Law & Scalability Saturation
For a small matrix size (100 \times 100), the computational workload was insufficient to justify higher parallelism. The results provide a practical demonstration of Amdahl’s Law: the speedup is limited by the sequential component (communication).
